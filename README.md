...
## :pushpin: Projects
## 1. 개요
>본 프로젝트는 1인 가구의 영양 불균형 문제를 해결하기 위해 이미지 분석을 활용하여반찬 예측과 메뉴 추천 시스템을 개발하는 것을 목표로 합니다.<br>
...
### 6.2. Side Dish Prediction

### 6.3. Dinner Recommendation
